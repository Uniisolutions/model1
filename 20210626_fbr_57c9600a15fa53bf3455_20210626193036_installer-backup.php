...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210626_fbr_57c9600a15fa53bf3455_20210626193036_archive.zip';
	const ARCHIVE_SIZE		 = '66183468';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '57c9600-26193036';
    const SECONDARY_PACKAGE_HASH = '9a918d8-26193036';
	const VERSION			 = '1.4.1';
